...
import { X, Moon, Sun, Download, Upload, Monitor, FolderCog, BookmarkPlus } from 'lucide-react';
          ...
          <div className="p-8 space-y-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="flex items-center gap-3">
                    <FolderCog size={18} className="text-brand-DEFAULT" />
                    {t('settings.category_mgmt')}
                  </span>
                </button>
